...
case "$ARCH" in
    x86_64)
        BUILD_ID="311316992"
        EXPECTED_SHA256SUM=bb305539368007a66b1117c033dfac39a4c640e9a8590bed460a9302a88dc8a9
        HM_ATTR=pedro-pedro-G3
        ;;
    aarch64)
        BUILD_ID="311250514"
        EXPECTED_SHA256SUM=c348064240e178d53679079e6b1025294bcd49d15d5c3558702d7ae7f7bc7663
        HM_ATTR=bob
        ;;
    *)
